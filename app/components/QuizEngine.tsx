      ...
      <section className="px-5 pb-5">
        <div className="flex items-center justify-between text-[11px]">
          ...
          <span className="font-semibold text-primary">
            現在スコア {Math.round((correctCount / total) * 100)}点（暫定）
          </span>
        </div>
            ...
            <li key={choice}>
              ...
              >
                ...
                {answered && i === current.answerIndex && (
                  <span className="ml-auto text-[10px] font-semibold text-primary">正解</span>
                )}
                {answered && selected === i && i !== current.answerIndex && (
                  <span className="ml-auto text-[10px] font-semibold text-[#9b3b3b]">不正解</span>
                )}
              </button>
            </li>
          ))}
